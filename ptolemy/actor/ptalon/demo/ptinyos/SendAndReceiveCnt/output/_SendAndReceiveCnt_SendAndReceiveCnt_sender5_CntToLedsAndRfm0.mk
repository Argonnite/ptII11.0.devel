...
COMPONENT=_SendAndReceiveCnt_SendAndReceiveCnt_sender5_CntToLedsAndRfm0
PFLAGS += -I%T/lib/Counters
PFLAGS += -DCOMMAND_PORT=10592 -DEVENT_PORT=10593
PFLAGS +=-D_PTII_NODEID=5
MY_PTCC_FLAGS += -D_PTII_NODE_NAME=_1SendAndReceiveCnt_1SendAndReceiveCnt_1sender5_1CntToLedsAndRfm0
