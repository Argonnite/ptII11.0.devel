...
COMPONENT=_SendAndReceiveCnt_SendAndReceiveCnt_receiver1_RfmToLeds0
PFLAGS += -I%T/lib/Counters
PFLAGS += -DCOMMAND_PORT=10594 -DEVENT_PORT=10595
PFLAGS +=-D_PTII_NODEID=6
MY_PTCC_FLAGS += -D_PTII_NODE_NAME=_1SendAndReceiveCnt_1SendAndReceiveCnt_1receiver1_1RfmToLeds0
